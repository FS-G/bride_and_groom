...
REM ============================================================================
REM  Model Finetuning Script Runner
...
REM  - Runs the model fine-tuning script (finetune.py).
REM ============================================================================
...
ECHO.
ECHO ======================================================
ECHO  Starting the fine-tuning process (finetune.py)...
ECHO ======================================================
ECHO.
...
IF %ERRORLEVEL% NEQ 0 (
    ECHO.
    ECHO ******************************************************
    ECHO *  ERROR: The finetune.py script failed to execute.  *
    ECHO *  Please check the output above for details.        *
    ECHO ******************************************************
) ELSE (
    ECHO.
    ECHO ******************************************************
    ECHO *  SUCCESS: The finetune.py script finished.         *
    ECHO ******************************************************
)
